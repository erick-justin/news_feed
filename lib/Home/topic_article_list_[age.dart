...
class TopicArticlesListPage extends StatefulWidget{
  String topic;
  TopicArticlesListPage(this.topic,{Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return TopicArticlesListPageState(topic);
  }

}


class TopicArticlesListPageState extends State<TopicArticlesListPage>{
  ...
  TopicArticlesListPageState(this.topic);
